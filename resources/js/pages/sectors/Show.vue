...
import type { AssetListItem, PaginationMeta, SectorDetail } from '@/types';
...
<template>
    <Head :title="t('sectorDetail.title', { sector: sector.name })">
        <meta
            name="description"
            :content="t('meta.sectorDetail', { sector: sector.name })"
        />
    </Head>
                ...
                >
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <div
                                v-if="sector.marketsBreakdown.length > 0"
                                class="mt-3 flex flex-wrap items-center gap-2"
                            >
                                <span class="text-sm text-muted-foreground"
                                    >{{
                                        t('sectorDetail.marketsIncluded')
                                    }}:</span
                                >
                                <span
                    ...
                    <div class="flex items-center gap-6">
                        ...
                        <div class="text-center">
                            <p class="text-2xl font-bold tabular-nums">
                                {{ sector.predictionCount }}
                            </p>
                            <p
                                class="text-xs tracking-wide text-muted-foreground uppercase"
                            >
                                {{ t('sectors.predictions') }}
                            </p>
                        </div>
                    </div>
                </div>
                                    ...
                                    <thead>
                                        ...
                                        >
                                            ...
                                            >
                                                {{
                                                    t(
                                                        'sectorDetail.table.predictedPrice',
                                                    )
                                                }}
                                            </th>
                                            <th
                    ...
                    <Card>
                        ...
                        <CardContent class="space-y-3">
                            <div class="flex items-center justify-between">
                                <span class="text-sm text-muted-foreground">{{
                                    t('sectorDetail.stats.totalAssets')
                                }}</span>
                            ...
                            <div class="flex items-center justify-between">
                                <span class="text-sm text-muted-foreground">{{
                                    t(
                                        'sectorDetail.stats.assetsWithPredictions',
                                    )
                                }}</span>
                                <span class="font-medium tabular-nums">{{
