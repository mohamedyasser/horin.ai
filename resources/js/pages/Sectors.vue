                            ...
                            <table class="w-full">
                                ...
                                <tbody>
                                    ...
                                    >
                                        ...
                                        <td
                                            class="px-4 py-4 text-end tabular-nums"
                                        >
                                            <span class="font-medium">{{
                                                sector.assetCount
                                            }}</span>
                                            <span
                                                class="ms-1 text-sm text-muted-foreground"
                                                >{{ t('sectors.assets') }}</span
                                            >
                                        </td>
                                        <td
                                            class="px-4 py-4 text-end tabular-nums"
                                        ...
                                        <td class="px-4 py-4">
                                            <div class="flex flex-wrap gap-1">
                                                <span
                                                    v-for="m in sector.marketsBreakdown.slice(
                                                        0,
                                                        4,
                                                    )"
                                                    :key="m.marketId"
                                        ...
                                        <td class="px-4 py-4 text-center">
                                            ...
                                            >
                                                ...
                                                <ArrowRight
                                                    class="ms-1 size-4 rtl:rotate-180"
                                                />
                                            </Button>
                                        </td>
                                    </ClickableTableRow>
                    ...
                    <Card v-if="trendingSector">
                        ...
                        <CardContent>
                            <LocalizedLink
                                ...
                                class="-mx-2 block rounded px-2 py-2 transition-colors hover:bg-muted/30"
                            >
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            >
                                                {{
                                                    trendingSector.predictionCount
                                                }}
                                                {{ t('sectors.predictions') }}
                                            </p>
                                        </div>
