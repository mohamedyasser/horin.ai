...
import type { PaginationMeta, PredictionListItem } from '@/types';
            ...
            <div class="grid gap-6 lg:grid-cols-4">
                ...
                <div class="lg:col-span-3">
                    ...
                    <Deferred data="predictions">
                                ...
                                <table class="w-full">
                                    <thead>
                                        ...
                                        >
                                            ...
                                            >
                                                {{
                                                    t(
                                                        'predictions.table.predictedPrice',
                                                    )
                                                }}
                                            </th>
                                            <th
                                    ...
                                    <tbody>
                                        ...
                                        >
                                            ...
                                            >
                                                {{
                                                    prediction.asset.currentPrice?.toFixed(
                                                        2,
                                                    ) ?? '-'
                                                }}
                                            </td>
                        ...
                        <div
                            v-if="
                                predictionsMeta && predictionsMeta.lastPage > 1
                            "
                        ...
                        >
                            <Button
                                ...
                                @click="
                                    goToPage(predictionsMeta.currentPage - 1)
                                "
                            >
                                {{ t('common.previous') }}
                            </Button>
                            ...
                            >
                                {{ predictionsMeta.currentPage }} /
                                {{ predictionsMeta.lastPage }}
                            </span>
                            <Button
                                variant="outline"
                                size="sm"
