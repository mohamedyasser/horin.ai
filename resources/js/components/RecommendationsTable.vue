...
import { Minus, Search, TrendingDown, TrendingUp } from 'lucide-vue-next';
import { useI18n } from 'vue-i18n';

const { t, locale } = useI18n();
const { getActionColor, getActionIcon, formatTimeAgo } =
                ...
                <tbody>
                    ...
                    >
                        ...
                        <td class="px-4 py-3 text-center">
                            ...
                            >
                                <component
                                    :is="getIconComponent(rec.recommendation)"
                                    class="size-3"
                                />
                                {{
                                    t(
                                        `recommendations.actions.${rec.recommendation}`,
                                    )
                                }}
                            </span>
                        </td>
                        ...
                        <td
                            class="px-4 py-3 text-end text-sm text-muted-foreground"
                        >
